								   ...
								   double c_d_d, double c_d_dd, FrenetPath lp, double bot_yaw)
{
	...
	double endTime1 = omp_get_wtime();
	//cerr<<"calc_frenet_paths function: " << endTime1-startTime1<<endl;
	std::string endTime1_startTime1 = std::to_string(endTime1-startTime1);
	std::string calc_frenet_paths_function = "calc_frenet_paths function: ";
	std::string calc_frenet_paths_function_str = calc_frenet_paths_function + endTime1_startTime1;
	RCLCPP_INFO(node->get_logger(), calc_frenet_paths_function_str);

	trace("calc_global_paths");
	double startTime2 = omp_get_wtime();
	fplist = calc_global_paths(fplist, csp);
	double endTime2 = omp_get_wtime();
	//cerr<<"calc_global_paths function: "<<endTime2-startTime2<<endl;
	std::string endTime2_startTime2 = std::to_string(endTime2-startTime2);
	std::string calc_global_paths_function = "calc_global_paths function: ";
	std::string calc_global_paths_function_str = calc_global_paths_function + endTime1_startTime1;
	RCLCPP_INFO(node->get_logger(), calc_global_paths_function_str);
	...
	//cerr<<"check_path function: "<<endTime3-startTime3<<endl;
	std::string endTime3_startTime3 = std::to_string(endTime3-startTime3);
	std::string calc_path_function = "calc_path function: ";
	std::string calc_path_function_str = calc_path_function + endTime3_startTime3;
	RCLCPP_INFO(node->get_logger(), calc_path_function_str);	
